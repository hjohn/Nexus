...
enum KeyCode {
  ...
  KEY_RIGHTBRACE(27),
  KEY_ENTER(28),
  KEY_LEFTCTRL(29, Modifier.CONTROL),
  KEY_A(30),
  KEY_S(31),
  KEY_D(32),
  KEY_F(33),
  ...
  KEY_APOSTROPHE(40),
  KEY_GRAVE(41),
  KEY_LEFTSHIFT(42, Modifier.SHIFT),
  KEY_BACKSLASH(43),
  KEY_Z(44),
  KEY_X(45),
  KEY_C(46),
  ...
  KEY_DOT(52),
  KEY_SLASH(53),
  KEY_RIGHTSHIFT(54, Modifier.SHIFT),
  KEY_KPASTERISK(55),
  KEY_LEFTALT(56, Modifier.ALT),
  KEY_SPACE(57),
  KEY_CAPSLOCK(58),
  KEY_F1(59),
  KEY_F2(60),
  ...
  KEY_KPJPCOMMA(95),
  KEY_KPENTER(96),
  KEY_RIGHTCTRL(97, Modifier.CONTROL),
  KEY_KPSLASH(98),
  KEY_SYSRQ(99),
  KEY_RIGHTALT(100, Modifier.ALT),
  KEY_LINEFEED(101),
  KEY_HOME(102),
  KEY_UP(103),
  KEY_PAGEUP(104),
  ...
  KEY_HANJA(123),
  KEY_YEN(124),
  KEY_LEFTMETA(125, Modifier.META),
  KEY_RIGHTMETA(126, Modifier.META),
  KEY_COMPOSE(127),
  ...
  KEY_MSDOS(151),
  KEY_SCREENLOCK(152), /* AL Terminal Lock/Screensaver */
  KEY_DIRECTION(153),
  ...
  private static final Map<Integer, KeyCode> codes = Arrays.stream(KeyCode.values())
    .collect(Collectors.toMap(kc -> kc.id, Function.identity()));

  public static KeyCode fromId(int id) {
    return codes.get(id);
  }
  ...
  KeyCode(int id, Modifier modifier) {
    this.id = id;
